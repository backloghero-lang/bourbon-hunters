...
- [ ] **Oceny użytkownika (własne gwiazdki).** Pozwolić userowi wystawiać własną ocenę butelce (gwiazdki), zapis w localStorage, pokazywane na liście zamiast/obok oceny z bazy. Teraz: gdy brak oceny w bazie → pusta gwiazdka.
