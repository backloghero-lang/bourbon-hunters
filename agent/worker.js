...
async function callVisualAgent(env, mime, image, foreground, requestedModel){
  ...
  const searchGrounding=String(env.GEMINI_SEARCH_GROUNDING||"1")==="1";
