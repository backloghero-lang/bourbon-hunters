...
- [ ] Provider email transakcyjny: Worker ma juz Resend dla welcome/reset. Do zrobienia w Cloudflare: DNS domeny, sekret `RESEND_API_KEY`, zmienne `MAIL_FROM`, `APP_URL`, `SUPPORT_EMAIL` oraz mail potwierdzenia/usuniecia danych.
