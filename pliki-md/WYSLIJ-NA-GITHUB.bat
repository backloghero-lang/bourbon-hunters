...
git add -A -- index.html spirit-taxonomy.js sw.js manifest.json test-index.html .nojekyll .github/workflows/deploy-pages.yml README.md WYSLIJ-NA-GITHUB.bat OTWORZ-PLUGIN-FIGMA-ASSETY.bat pliki-md regulaminy assets/detail/bottle-detail-bg.png assets/brand assets/profile-badges "assets/Assety do aplikacji" db/bourbons.json db/profiles-runtime.json db/catalog scripts agent/worker.js agent/d1-schema.sql agent/d1-migration-v57-auth-age.sql agent/d1-migration-v60-password-reset.sql agent/d1-migration-v61-user-profile.sql agent/d1-migration-v62-recommendations.sql agent/d1-migration-v63-google-auth.sql agent/d1-migration-v64-catalog-submissions.sql agent/d1-migration-v65-catalog-data-lifecycle.sql agent/d1-migration-v66-telemetry-reports.sql agent/d1-migration-v67-catalog-moderation.sql agent/prompt.txt design/figma-assets/home-pack-v2 design/figma-import-plugin/code.js design/figma-import-plugin/manifest.json
