...
await page.evaluate((id)=>{
  ...
  renderScanConfirmation({
    scan_id:"scan-single",
    mode:"rate",
    candidates:[{id:id,name:"Bulleit Bottled in Bond",confidence:.96,result:{id:id,name:"Bulleit Bottled in Bond",category:"Bottled in Bond"}}]
  });
},bottleId);
...
await page.evaluate((id)=>{
  renderScanConfirmation({
    ...
    mode:"rate",
    candidates:[
      {id:id,name:"Bulleit Bottled in Bond",confidence:.96,result:{id:id,name:"Bulleit Bottled in Bond",category:"Bottled in Bond"}},
