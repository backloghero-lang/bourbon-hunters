...
if (catalog.count !== 10000 || catalog.bottles.length !== 10000) fail(`catalog count is ${catalog.bottles.length}, expected 10000`);
if (scan.count !== 10000 || scan.bottles.length !== 10000) fail(`scan index count is ${scan.bottles.length}, expected 10000`);
if (!scan.token_index || Object.keys(scan.token_index).length < 1000) fail("scan token index is missing or unexpectedly small");
if (report.count !== 10000) fail(`quality report count is ${report.count}, expected 10000`);
